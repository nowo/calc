---
title: Aggregation
description: calcSum / calcAvg / calcMax / calcMin — array aggregation.
icon: i-lucide-sigma
---

# Aggregation

Compute sum / average / max / min directly over a plain array or an array of objects. All results are strings.
...
Real-world API responses often contain `null` / `undefined`. All four aggregation functions **automatically skip null values** without throwing:
